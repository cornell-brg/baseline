    ...
    def __generate_tile_stats(self, traces, tiles):
        ...
        for trace in traces:
            ...
            if(cst.isStart):
                ...
                tile_stat[cst.tag][cur_tile]["start_cycle"] = tile_stat_start[cst.tag][cur_tile]["global_ctr"]
                tile_stat[cst.tag][cur_tile]["end_cycle"] = tile_stat_end[cst.tag][cur_tile]["global_ctr"]
            ...
            if(cst.isKernelStart):
                ...
                tile_stat["kernel"][cur_tile]["start_cycle"] = tile_stat_start["kernel"][cur_tile]["global_ctr"]
                tile_stat["kernel"][cur_tile]["end_cycle"] = tile_stat_end["kernel"][cur_tile]["global_ctr"]
