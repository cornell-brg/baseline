 ...
 */
extern "C" {
        int  __attribute__ ((noinline)) kernel_parallel_sort_int(
                      int *A, int *B, int *C,
                      uint32_t WIDTH,
                ...
                for(int i = 0; i <= iter; ++i){
                        ...
                        rc = kernel_parallel_sort_single_tile_group(A, B, C, WIDTH);
        ...
        int  __attribute__ ((noinline)) kernel_parallel_sort_int16(
        ...
        int  __attribute__ ((noinline)) kernel_parallel_sort_int8(
        ...
        int  __attribute__ ((noinline)) kernel_parallel_sort_float(
